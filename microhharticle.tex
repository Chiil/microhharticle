...
\begin{eqnarray}
\widehat{\phi}^   x_{i,j} & \equiv & \dfrac{\phi_{i-\frac{1}{2},j} + \phi_{i+\frac{1}{2},j}}{2},\\
\widehat{\phi}^{3x}_{i,j} & \equiv & \dfrac{\phi_{i-\frac{3}{2},j} + \phi_{i+\frac{3}{2},j}}{2},
\end{eqnarray}

\begin{eqnarray}
\left. \dfrac{\partial \phi}{\partial x}\right|_{i,j} \equiv \dfrac{\phi_{i+\frac{1}{2},j} - \phi_{i-\frac{1}{2},j}}
                                                                   {   x_{i+\frac{1}{2},j} -    x_{i-\frac{1}{2},j}}
\end{eqnarray}

\begin{eqnarray}
\left. \dfrac{\partial \phi}{\partial x}\right|_{i,j} \equiv \dfrac{\phi_{i+\frac{3}{2},j} - \phi_{i-\frac{3}{2},j}}
                                                                   {   x_{i+\frac{3}{2},j} -    x_{i-\frac{3}{2},j}}
\end{eqnarray}
...
\begin{eqnarray}
\widehat{\phi}^x_{i,j} \equiv \dfrac{- \phi_{i-\frac{3}{2},j} + 9 \phi_{i-\frac{1}{2},j} + 9 \phi_{i+\frac{1}{2},j} - \phi_{i+\frac{3}{2},j}}{16}\label{eq:interp4}
\end{eqnarray}

\begin{eqnarray}
\widehat{\phi}^x_{i,j} \equiv \dfrac{ 5 \phi_{i-\frac{1}{2},j} + 15 \phi_{i+\frac{1}{2},j} - 5 \phi_{i+\frac{3}{2},j} + \phi_{i+\frac{5}{2},j}}{16}
\end{eqnarray}

\begin{eqnarray}
\left. \dfrac{\partial \phi}{\partial x}\right|_{i,j} = \dfrac{\phi_{i-\frac{3}{2},j} - 27 \phi_{i-\frac{1}{2},j} + 27 \phi_{i+\frac{1}{2},j} - \phi_{i+\frac{3}{2},j}}
                                                              {   x_{i-\frac{3}{2}} - 27    x_{i-\frac{1}{2}} + 27    x_{i+\frac{1}{2}} -    x_{i+\frac{3}{2}}}
\end{eqnarray}

\begin{eqnarray}
\left. \dfrac{\partial \phi}{\partial x}\right|_{i,j} = \dfrac{-23 \phi_{i-\frac{1}{2},j} + 21 \phi_{i+\frac{1}{2},j} + 3 \phi_{i+\frac{3}{2},j} - \phi_{i+\frac{5}{2},j}}
...
\begin{eqnarray}
\nonumber \left. \dfrac{\partial^2 \phi}{\partial x^2}\right|_{i,j} =
...
\begin{eqnarray}
\nonumber
\dfrac{\partial u \phi}{\partial x} + \dfrac{\partial v \phi}{\partial y} = \dfrac{ u_{i+\frac{1}{2},j} \widehat{\phi}^x_{i+\frac{1}{2},j} - u_{i-\frac{1}{2},j} \widehat{\phi}^x_{i-\frac{1}{2},j} }
                                                                                  { x_{i+\frac{1}{2}} - x_{i-\frac{1}{2}} }\\
                                                                          + \dfrac{ v_{i,j+\frac{1}{2}} \widehat{\phi}^y_{i,j+\frac{1}{2}} - v_{i,j-\frac{1}{2}} \widehat{\phi}^y_{i,j-\frac{1}{2}} }
                                                                                  { y_{j+\frac{1}{2}} - y_{j-\frac{1}{2}} }
\end{eqnarray}

\begin{eqnarray}
\dfrac{\partial v u}{\partial x} = \dfrac{ \widehat{v}^y_{i+\frac{1}{2},j} \widehat{u}^x_{i+\frac{1}{2},j} - \widehat{v}^y_{i-\frac{1}{2},j} \widehat{u}^x_{i-\frac{1}{2},j} }
...
\left( u_{i-\frac{3}{2},j} \widehat{\phi}^x_{i-\frac{3}{2},j} - 27 u_{i-\frac{1}{2},j} \widehat{\phi}^x_{i-\frac{1}{2},j} \right.\\
\nonumber
&&\left. + 27 u_{i+\frac{1}{2},j} \widehat{\phi}^x_{i+\frac{1}{2},j} - u_{i+\frac{3}{2},j} \widehat{\phi}^x_{i+\frac{3}{2},j} \right)\\
...
\begin{eqnarray}
\nonumber
\left. \dfrac{\partial u \phi}{\partial x} \right|_{i,j}  & = & \dfrac{9}{16} \dfrac{ u_{i+\frac{1}{2},j} \widehat{\phi}^x_{i+\frac{1}{2},j} - u_{i-\frac{1}{2},j} \widehat{\phi}^x_{i-\frac{1}{2},j} }
                                                                                    { x_{i+\frac{1}{2}} - x_{i-\frac{1}{2}} }\\
                                                          & - & \dfrac{9}{16} \dfrac{ u_{i+\frac{3}{2},j} \widehat{\phi}^{3x}_{i+\frac{3}{2},j} - u_{i-\frac{3}{2},j} \widehat{\phi}^{3x}_{i-\frac{3}{2},j} }
                                                                                    { x_{i+\frac{3}{2}} - x_{i-\frac{3}{2}} }
\end{eqnarray}
Note that in this scheme velocity interpolations, such as in Eq. \ref{eq:advec2u}, still need to be performed with fourth order accuracy (Eq. \ref{eq:interp4}) in order to keep the total operator fourth order accurate.
\subsection{Diffusion}
The diffusion operator is calculated as a divergence of a gradient:
\begin{eqnarray}
\left. \kappa_\phi \dfrac{\partial^2 \phi}{\partial x^2}\right|_{i,j} \equiv 
...
\left. u_i\right|^{t+1}_{i,j,k} & = & \left. \widetilde{u_i} \right|^{t+1}_{i,j,k} - \Delta t \left. \dfrac{\partial p}{\partial x}\right|_{i,j,k}
\end{eqnarray}
Bla \ref{eq:poisson}
