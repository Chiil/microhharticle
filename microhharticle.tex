...
\begin{figure}[t]
	\vspace*{2mm}
	\begin{center}
		\includegraphics[width=5cm]{figs/f01.pdf}
	...
	\end{center}
	\caption{Schematic of the diffusion discretization near the wall. The green node is the evaluation point at the center of the first cell above the wall, the red nodes are the stencil of the divergence operator, and yellow nodes show the stencils of the four gradient operators over which the divergence is evaluated. White nodes indicate the extent of the stencil.} \label{fig:stencil_wall}
\end{figure}
% \begin{eqnarray}
% \nonumber
...
\begin{figure}[t]
	\vspace*{2mm}
	\begin{center}
		\includegraphics[width=8.3cm]{figs/f02.pdf}
	\end{center}
...
\vspace*{2mm}
\begin{center}
\includegraphics[width=8.3cm]{figs/f03.pdf}
\end{center}
...
\begin{figure}[t]
	\vspace*{2mm}
	\begin{center}
		\includegraphics[width=8.3cm]{figs/f04.pdf}
	\end{center}
...
\begin{figure}[t]
	\vspace*{2mm}
	\begin{center}
		\includegraphics[width=8.3cm]{figs/f05.pdf}
	\end{center}
...
\vspace*{2mm}
\begin{center}
\includegraphics[width=16.6cm]{figs/f06.pdf}
\end{center}
...
\vspace*{2mm}
\begin{center}
\includegraphics[width=16.6cm]{figs/f07.pdf}
\end{center}
...
\begin{figure}[t]
	\vspace*{2mm}
	\begin{center}
		\includegraphics[width=8.3cm]{figs/f08.pdf}
	\end{center}
...
\begin{figure}[t]
	\vspace*{2mm}
	\begin{center}
		\includegraphics[width=8.3cm]{figs/f09.pdf}
	\end{center}
...
\begin{figure*}[t]
	\vspace*{2mm}
	\begin{center}
		\includegraphics[width=16.6cm]{figs/f10.pdf}
	\end{center}
...
\vspace*{2mm}
\begin{center}
\includegraphics[width=16.6cm]{figs/f11.pdf}
\end{center}
...
\begin{figure}[!hbt]
	\vspace*{2mm}
	\begin{center}
		\includegraphics[width=8.3cm]{figs/f12.pdf}
	\end{center}
