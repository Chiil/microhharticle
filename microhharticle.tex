...
\end{eqnarray}
Whereas diffusion can be computed with fourth-order accuracy using a five-point stencil, we use a seven-point stencil as it extends naturally to non-uniform grids as explained in \citet{Castillo1995}.
