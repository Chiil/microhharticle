...
\begin{eqnarray}
\widehat{\phi}^x_{i,j,k} = \left( \phi_{i,j,k} \right) & \equiv & \dfrac{\phi_{i-\frac{1}{2},j,k} + \phi_{i+\frac{1}{2},j,k}}{2},\\
\widehat{\phi}^{3x}_{i,j,k} = \left( \phi_{i,j,k} \right) & \equiv & \dfrac{\phi_{i-\frac{3}{2},j,k} + \phi_{i+\frac{3}{2},j,k}}{2},
\end{eqnarray}

\begin{eqnarray}
%\left. \dfrac{\partial \phi}{\partial x}\right|_i = \dfrac{- \phi_{i-\frac{1}{2}} + \phi_{i+\frac{1}{2}}}
%                                                          {-    x_{i-\frac{1}{2}} +    x_{i+\frac{1}{2}}}
\left. \dfrac{\partial \phi}{\partial x}\right|_{i,j,k} = G_{2x} \left( \phi_{i,j,k} \right) \equiv \dfrac{- \phi_{i-\frac{1}{2},j,k} + \phi_{i+\frac{1}{2},j,k}}
...
%\left. \dfrac{\partial \phi}{\partial x}\right|_i = \dfrac{- \phi_{i-\frac{1}{2}} + \phi_{i+\frac{1}{2}}}
%                                                          {-    x_{i-\frac{1}{2}} +    x_{i+\frac{1}{2}}}
\left. \dfrac{\partial \phi}{\partial x}\right|_{i,j,k} = G_{2x} \left( \phi_{i,j,k} \right) \equiv \dfrac{- \phi_{3-\frac{1}{2},j,k} + \phi_{i+\frac{1}{2},j,k}}
                                                                                                          {-    x_{i-\frac{1}{2},j,k} +    x_{i+\frac{1}{2},j,k}}
\end{eqnarray}
...
I_{4x} \equiv \dfrac{- \phi_{i-\frac{3}{2},j,k} + 9 \phi_{i-\frac{1}{2},j,k} + 9 \phi_{i+\frac{1}{2},j,k} - \phi_{i+\frac{3}{2},j,k}}{16}\label{eq:interp4}
\end{eqnarray}
...
\begin{eqnarray}
\nonumber
\dfrac{\partial u \phi}{\partial x} & = & \dfrac{9}{16} \dfrac{ u_{i+\frac{3}{2},j} \widehat{\phi}^{3x}_{i+\frac{3}{2},j} - u_{i-\frac{3}{2},j} \widehat{\phi}^{3x}_{i-\frac{3}{2},j} }
                                                              { x_{i+\frac{3}{2}} - x_{i-\frac{3}{2}} }\\
                                    & - & \dfrac{1}{16} \dfrac{ u_{i+\frac{1}{2},j} \widehat{\phi}^x_{i+\frac{1}{2},j} - u_{i-\frac{1}{2},j} \widehat{\phi}^x_{i-\frac{1}{2},j} }
                                                              { x_{i+\frac{1}{2}} - x_{i-\frac{1}{2}} }
\end{eqnarray}
