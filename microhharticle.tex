...
\end{eqnarray}
\begin{eqnarray}
\left. \delta_{nx_i} \left( \rho_0 u_i\right) \right|^{t+1}_{i,j,k} & = & 
\left. \delta_{nx_i} \left( \rho_0 \widetilde{u_i} \right) \right|^{t+1}_{i,j,k}\\
& - &  \Delta t \left.\delta_{nx_i} \left[ \rho_0 \delta_{nx_i}\left( \dfrac{p}{\rho_0}\right) \right] \right|^t_{i,j,k}
\end{eqnarray}
...
\begin{eqnarray}
\dfrac{\left. \delta_{nx_i} \left( \rho_0 \widetilde{u_i} \right) \right|^{t+1}_{i,j,k}}{\Delta t}
& = &  \left. \delta_{nx_i} \left[ \rho_0 \delta_{nx_i}\left( \dfrac{p}{\rho_0}\right) \right] \right|^t_{i,j,k},
\end{eqnarray}
...
+ \delta_{nz} \left[ \rho_0 \delta_{nz} \left( \widehat{\pi} \right) \right]_{l,m,k},
\end{eqnarray}
