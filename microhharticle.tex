...
In addition to the three-dimensional output of the prognostic variables required to restart the model (Section MODEL-PROCEDURE), it is possible to save three-dimensional output of derived diagnostic variables. Furthermore, two-dimensional cross sections of both prognostic and derived diagnostic variables can be output in $xy$, $xz$ and $yz$-slices, at a user-specified location and interval. The code can easily be extended with new options for cross sections of user-defined diagnostic variables. 
